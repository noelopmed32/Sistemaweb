...
//http://localhost/Como-recuperar-clave-de-usuario-usando-PHP-y-MYSQL/nuevaClave.php?tokenUser=fdsfsdfFfDF&idusuario=12
if($_REQUEST['tokenUser'] !="" && $_REQUEST['idusuario'] !=""){ ?>
